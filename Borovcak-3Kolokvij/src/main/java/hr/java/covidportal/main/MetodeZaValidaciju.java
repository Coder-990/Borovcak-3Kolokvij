...
public class MetodeZaValidaciju {
    ...
    /**
     * Služi za provjeru nad objektima klase tipa Osoba da li unesena ista osobe vise puta gdje se onda baca nova oznadena iznimka 'PonovljenaOsobaException', prima objekt klase tipa Osoba i polje objekata klase tipa Osoba, a ne vraća ništa.
     ...
     */
    protected static void provjeraPonovljeneOsobe(Osoba osoba, Osoba[] osobe) throws PonovljenaOsobaException {
     ...
     * @param osobe Osoba[] polje objekata služi za provjeru unosa nad osobom za svaku osobu koja se unosi, dal je tsa osoba unesena.
     * @param i  Integer indeks elementa od objekta osobe.
     */
    protected static void hvatanjeOznaceneIznimkePonovljenaOsoba(Scanner scan, Zupanija[] zupanije, Bolest[] bolesti, Osoba[] osobe, int i) {
        ...
        do {
            ...
            try {
                ...
                vrtiPetlju = true;
                brojacEx++;
                logger.error("Pogreska, dogodila se nova oznacena iznimka, odabrana je osoba sa istim imenom, prezimenom, starosti i zupanijom prebivalista!");
     ...
     * @param osoba Osoba provjera jednakosti jednog objekta tipa Osoba nad poljem objekata klase tipa Osoba[].
     * @param osobe Osoba[] prosljeđivanje svih osoba sa kojima se uspoređuje da li postoji dva puta isto odabrana osoba.
     * @throws DuplikatKontaktiraneOsobeException bacanje iznimke nakon sto se odabere ista osoba
     */
     ...
     */
    protected static void hvatanjeOznaceneIznimkeDuplikataOsobe(Scanner scan, Osoba[] osobe, Osoba[]
            kontaktiraneOsobe, Integer i) {
     ...
     */
    protected static void hvatanjeNeoznaceneIznimkeBolestIstihSimptoma(Scanner scan, Simptom[] simptomi, Bolest[]
            bolesti, Integer i) {
