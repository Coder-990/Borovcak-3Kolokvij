...
public class MetodeZaUnosPodataka {
     ...
     */
    protected static Osoba unosOsobe(Scanner scan, Zupanija[] zupanije, Bolest[] bolesti, Osoba[] osobe, Integer i) throws DuplikatKontaktiraneOsobeException, PonovljenaOsobaException {
